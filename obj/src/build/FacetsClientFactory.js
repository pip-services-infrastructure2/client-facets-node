...
const FacetsMockClientV1_1 = require("../version1/FacetsMockClientV1");
...
class FacetsClientFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(FacetsClientFactory.MockClientV1Descriptor, FacetsMockClientV1_1.FacetsMockClientV1);
...
FacetsClientFactory.MockClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor('service-facets', 'client', 'mock', 'default', '1.0');
